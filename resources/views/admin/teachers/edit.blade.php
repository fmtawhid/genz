    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <!-- Form to add a new teacher -->
                    <form id="CreateTeacher" action="{{ route('teacher.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <!-- Teacher Name -->
                            <div class="mb-3 col-md-6">
                                <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                                <input class="form-control" name="name" value="{{ old('name', $teacher->name) }}" type="text"
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="designation" class="form-label">Designation <span
                                        class="text-danger">*</span></label>
                                <input class="form-control" name="designation" value="{{ old('designation', $teacher->designation) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="phone_number" value="{{ old('phone_number', $teacher->phone_number) }}"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="email" value="{{ old('email', $teacher->email) }}" type="email"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="facebook_link" value="{{ old('facebook_link', $teacher->facebook_link) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="date_of_joining" value="{{ old('date_of_joining', $teacher->date_of_joining) }}"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="salary" value="{{ old('salary', $teacher->salary) }}" type="number"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="qualification" value="{{ old('qualification', $teacher->qualification) }}"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control" name="status" id="status">
                                    ...
                                    <option value="inactive" {{ old('status', $teacher->status) == 'inactive' ? 'selected' : '' }}>Inactive
                                    </option>
                                </select>
                                @error('status')
                                    <div class="text-danger my-2">{{ $message }}</div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="years_of_experience"
                                    value="{{ old('years_of_experience', $teacher->years_of_experience) }}" type="number" id="years_of_experience"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="department" value="{{ old('department', $teacher->department) }}"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control" name="staff_type" id="staff_type">
                                    <option value="teacher" {{ old('staff_type', $teacher->staff_type) == 'teacher' ? 'selected' : '' }}>Teacher</option>
                                    <option value="staff" {{ old('staff_type', $teacher->staff_type) == 'staff' ? 'selected' : '' }}>Staff</option>
                                </select>
                                @error('staff_type')
                                    <div class="text-danger my-2">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="date_of_birth" type="date" id="date_of_birth" value="{{ old('date_of_birth', $teacher->date_of_birth) }}">
                                @error('date_of_birth')
                                    <div class="text-danger my-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" name="blood_group" type="text" id="blood_group" value="{{ old('blood_group', $teacher->blood_group) }}"
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" name="user_id" type="text" id="user_id" value="{{ old('user_id', $teacher->user_id) }}"
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" name="nid_number" type="text" id="nid_number" value="{{ old('nid_number', $teacher->nid_number) }}"
                                    placeholder="Enter Teacher's Unique User ID">
                                @error('nid_number')
                                    <div class="text-danger my-2">{{ $message }}</div>
                                @enderror
                            ...
                            @foreach ($teacher->attachments as $attachment)
                                <div class="existing-attachment position-relative" data-id="{{ $attachment->id }}">
                                    @if (in_array(strtolower($attachment->file_type), ['jpg', 'jpeg', 'png', 'gif', 'svg']))
                                        <a href="{{ asset('assets/attachments/' . $attachment->file_path) }}" data-lightbox="attachment-{{ $attachment->id }}" data-title="{{ $attachment->file_name }}">
                                            <img src="{{ asset('assets/attachments/' . $attachment->file_path) }}" alt="{{ $attachment->file_name }}" class="img-thumbnail attachment-image">
                                        </a>
                                    @elseif (strtolower($attachment->file_type) === 'pdf')
                                        <a href="{{ asset('assets/attachments/' . $attachment->file_path) }}" target="_blank" data-title="{{ $attachment->file_name }}">
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            // Save the selected files when save button is clicked
