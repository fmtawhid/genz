                    ...
                    <form id="createStudentForm" action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" name="form_number" value="{{ old('form_number') }}"
                            ...
                            <!-- User ID -->
                            <div class="mb-3 col-md-4">
                                <label for="dhakila_number" class="form-label">User ID <span class="text-danger">*</span></label>
                                <input class="form-control" name="dhakila_number" value="{{ old('dhakila_number') }}"
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" name="dhakila_date" value="{{ old('dhakila_date') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" name="father_name" value="{{ old('father_name') }}"
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" name="mobile" value="{{ old('mobile') }}"
                                    type="text" id="mobile" placeholder="Enter Mobile Number" required>
                                @error('mobile')
                                    <div class="text-danger my-2">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select class="form-control select2" id="bibag_id" name="bibag_id" style="width: 100%;">
                                    ...
                                    @foreach ($bibags as $bibag)
                                        <option value="{{ $bibag->id }}" {{ old('bibag_id') == $bibag->id ? 'selected' : '' }}>
                                            {{ $bibag->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input class="form-control" name="address" value="{{ old('address') }}"
                                    type="text" id="address" placeholder="Enter Present address" required>
                                @error('address')
                                    <div class="text-danger my-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select class="form-control" name="type" id="type" required>
                                    ...
                                    <option value="Deactive" {{ old('type') == 'Deactive' ? 'selected' : '' }}>Deactive</option>
                                </select>
                                @error('type')
                                    <div class="text-danger my-2">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" name="emergency_contact" type="text" id="emergency_contact"
                                    value="{{ old('emergency_contact') }}" placeholder="Enter Whatsapp Number">
